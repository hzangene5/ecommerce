        ...
        <div class="row">
          ...
          <div class="col-lg-3">
                ...
                <div class="list-group">
                   ...
                   ?>
                    <a href="index.php?cat=<?php echo $cat_row['id']; ?>" class="list-group-item"><?php echo $cat_row['cat_name']; ?></a>
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    <img class="card-img-top img-fluid" src="uploads/<?php echo $row['image']; ?>" alt="">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="index.php?cat=<?php echo $row['cat_id']; ?>" class="float-right">
                        <?php
                        $cat_id = $row['cat_id'];
